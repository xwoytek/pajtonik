...
def wybor():
    ...
    if inp == 'bulbasaur':
        ...
        argbh = input('paralizator z amazona za 15 centów')
        pikachu()
    mojlevel = 1
    print('\n')
...
def evolucja():
    if name == 'bulbasaur' and mojlevel == 16:
        print(f'Gratulacje!!! Twój pokemon ewoluował z {name}')
        name = 'ivysaur'
        print(f'do {name}')
    ...
    if name == 'charmeleon' and mojlevel == 32:
        print(f'Gratulacje!!! Twój pokemon ewoluował  {name}')
        name = 'charizard'
        print(f'do {name}')
...
def lapanie():
    ...
    if inp2 == 'pokekula':
        ...
        if losuj == 2456:
            print(f'Gratulacje!!! Złapałeś {nameenemy}')
            złapany = True
